<template>
   <div class="h-100 d-flex flex-column">
            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-xl mb-3 d-flex flex-column justify-content-end">
                  <label
                     for="c-brightness"
                     class="form-label"
                  >Brightness ({{ Math.round(dirtyConfig.animation.brightness / 255 * 100) }}%)</label>
                  <input
                     type="range"
                     class="form-range"
                     id="c-brightness"
            ...
            <div class="row">
               <div class="col-lg-6 mb-3" v-for="p of paramVms" :key="p.name">
                  <div v-if="p.meta.type === 'number'" class="mb-3">
                     ...
                     <small
                        class="text-muted"
                     >{{ p.meta.description }}. Default {{ p.meta.default }}</small>
                  </div>
      ...
      >Are you sure you want to delete this configuration?</v-confirmation-modal>
   </div>
</template>
