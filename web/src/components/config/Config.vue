...
<script lang="ts">
   ...
   import { AnimationRestClient, ConfigMetaParam, deepClone, DeviceAnimationPost, DeviceRestClient } from 'netled';
   ...
   export default defineComponent({
      ...
      async setup() {
         ...
         const devices = deepClone(await devicesClient.list(false));

         const animation = deepClone(await animationClient.latest(animationId.value, true));
